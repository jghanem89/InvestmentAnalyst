...
- Generate a thought/action belonging to the below tasks
...
- Move to next task in (1)
- Finish and return analysis summary
...
- The main agent that will break down the research into sub-tasks, receives results from the sub-agents and formulate the summary/recommendation
